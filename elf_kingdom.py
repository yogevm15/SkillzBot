...
class Elf(GameObject):
    ...
    __slots__ = (u"attack_range", u"attack_multiplier", u"max_speed", u"is_building", u"currently_building", u"turns_to_build", u"turns_to_revive", u"spawn_turns")
    _hx_fields = [u"attack_range", u"attack_multiplier", u"max_speed", u"is_building", u"currently_building", u"turns_to_build", u"turns_to_revive", u"spawn_turns"]
    _hx_methods = [u"build_portal", u"can_build_portal", u"build_mana_fountain", u"can_build_mana_fountain", u"in_attack_range", u"attack", u"move_to", u"enoughManaToBuild", u"is_alive"]
    _hx_statics = []
    _hx_interfaces = []
    _hx_super = GameObject
...
__all__ = ['Api', 'ObjectParser', 'BaseObject', 'Player', 'Game', 'GameObject', 'MapObject', 'Creature', 'IceTroll', 'LavaGiant', 'Elf', 'Castle', 'Portal', 'ManaFountain', 'Building', 'Location']
